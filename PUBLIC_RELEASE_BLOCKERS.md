...
The public package is not ready for GitHub until these checks are complete:

1. Confirm final license for code and derived outputs.
2. Remove active submission manuscript files and reviewer-facing drafts.
